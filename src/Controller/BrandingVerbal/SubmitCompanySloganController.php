...
class SubmitCompanySloganController extends AbstractController
{
    ...
    #[Route(path: '/brandingVerbal/companySlogan', name: 'submit__companySlogan', methods: ['POST'])]
    public function __invoke(
        ...
        $client = $this->brandingVerbalService->submitCompanySlogan($brandingVerbal);

        return $this->json([
            'success' => true,
            'message' => 'Company Slogan Submitted Successfully',
